...
- **Cek Hari Kerja & Libur**: Tentukan apakah sebuah tanggal termasuk hari kerja atau libur.
- **Menghitung Umur**: Hitung umur dalam format tahun dan bulan.
- **Validasi Tanggal**: Pastikan input tanggal valid sebelum digunakan.
- **Hitung Jumlah Hari Kerja**: Tentukan jumlah hari kerja dalam rentang tanggal tertentu.
